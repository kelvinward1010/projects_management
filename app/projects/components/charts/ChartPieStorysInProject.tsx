import { takeDataStorys, takeLengthStatus } from '@/app/equation';
...
function ChartPieStorysInProject({
    project
}:Props) {

    const dataStorys = takeDataStorys(project);
    const lengthInStatusEpics = takeLengthStatus(dataStorys)
    ...
    return (
        <div>
            <Title level={5}>1. Storys</Title>
            <PieChart {...config} />
        </div>
    )
}

export default ChartPieStorysInProject